...
class Chapter2Activity : AppCompatActivity() {
    private val correctAnswers = listOf(
        ...
        "Friedegg", "Pancake", "Waffle", "Steak", "Friedchicken",
        "Frenchfries", "Icecream", "Ramen", "Sandwich", "Salad"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foodImageView = findViewById(R.id.vehicleImageView)
    ...
    private fun updateQuestion() {
        val currentFood = correctAnswers[currentQuestionIndex]
        val drawableResourceId = resources.getIdentifier(currentFood.toLowerCase(), "drawable", packageName)
    ...
    private fun checkAnswer() {
        ...
        if (currentQuestionIndex < correctAnswers.size) {
            ...
            val intent = Intent(this, Score2Activity::class.java).apply {
