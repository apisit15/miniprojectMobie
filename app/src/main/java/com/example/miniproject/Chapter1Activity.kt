...
class Chapter1Activity : AppCompatActivity() {
    private val correctAnswers = listOf(
        ...
        "Zebra", "Monkey", "Dolphin", "Eagle", "Bear",
        "Kangaroo", "Horse", "Rabbit", "Snake"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animalImageView = findViewById(R.id.vehicleImageView)
    ...
    private fun updateQuestion() {
        val currentAnimal = correctAnswers[currentQuestionIndex]
        val drawableResourceId = resources.getIdentifier(currentAnimal.toLowerCase(), "drawable", packageName)
        animalImageView.setImageResource(drawableResourceId)
    ...
    private fun checkAnswer() {
        ...
        if (currentQuestionIndex < correctAnswers.size) {
            ...
            val intent = Intent(this, Score1Activity::class.java).apply {
